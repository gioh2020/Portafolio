...
function WwWhere(props) {
    ...
    return(
        <div   className={styles.principalDiv} onClick={props.handleClickClose} onTouch={props.handleClickClose}>
        ...
        <div className={styles.popUp} onClick={handleStopClick}  >
            ...
            <ReactPlayer width='96%' height='95%' className={styles.youtube} url='https://www.youtube.com/watch?v=tj72TZ_OdH0&ab_channel=SolGomezEstevez' />
